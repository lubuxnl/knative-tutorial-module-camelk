...
== Prerequisite 
As pre-requisite to this tutorial, its highly recommended that you have completed xref:knative-tutorial:ROOT:index.adoc[Knative Tutorial Basics] completed.
